...
//! - 画像コーデックのうち JPEG（DCTDecode。baseline / extended-sequential /
//!   progressive）・CCITTFaxDecode（T.4 1D / T.4 2D / T.6 MMR）・JBIG2Decode
//!   （T.88 算術経路: Generic / Symbol / Text / Refinement / Pattern /
//!   Halftone）はデコード対応。JPX は未対応（生データの取得は可能）
//! - レンダリングは画像 XObject・インライン画像（BitsPerComponent 1/2/4/8/16、
//!   /Decode、ImageMask、SMask、各種色空間、JPEG（baseline / progressive））と注釈の外観
